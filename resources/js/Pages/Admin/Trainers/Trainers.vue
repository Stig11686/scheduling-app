    ...
    <AuthenticatedLayout>
        ...
        <AdminDataDisplay>
            <template #data>
                ...
                <ul v-for="item in $page.props.trainers.data" :key="item.user.id" role="list" class="divide-y divide-gray-200">
                    <li>
                ...
                <Pagination class="mt-6" :links="$page.props.trainers.links" />
            </template>
        </AdminDataDisplay>
    </AuthenticatedLayout>
</template>
